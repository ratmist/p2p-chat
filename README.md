...
> **Safari / iOS:** микрофон и камера требуют HTTPS. Поэтому необходимо сгенерировать сертификат и применить в настройках ios, что не совсем удобно, но так тетсировалось
